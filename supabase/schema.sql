...
create table if not exists public.app_user_settings (
  ...
  constraint app_user_settings_upcoming_window_range check (upcoming_window_days between 1 and 60),
  constraint app_user_settings_grace_days_range check (grace_days between 0 and 30)
);
...
begin
  ...
  values (
    auth.uid(),
    greatest(1, least(coalesce(p_upcoming_window_days, 7), 60)),
    greatest(0, least(coalesce(p_grace_days, 0), 30))
  )
...
values
  ('captavale', 'CaptaVale', false, 'none', null, array[8,10,12,14,16]),
...
-- CAPTAVALE
-- Seguro ya incluido en el pago base (sin campo de seguro adicional en UI)
insert into public.loan_rate_tables (source_code, amount, term_quincenas, base_payment, is_available)
values
  ('captavale', 1000,  8,  201,  true),
  ('captavale', 1000,  10, 176,  true),
  ('captavale', 1000,  12, 145,  true),
  ('captavale', 1000,  14, 126,  true),
  ('captavale', 1000,  16, 107,  true),
  ('captavale', 2000,  8,  405,  true),
  ('captavale', 2000,  10, 342,  true),
  ('captavale', 2000,  12, 295,  true),
  ('captavale', 2000,  14, 253,  true),
  ('captavale', 2000,  16, 232,  true),
  ('captavale', 3000,  8,  601,  true),
  ('captavale', 3000,  10, 508,  true),
  ('captavale', 3000,  12, 440,  true),
  ('captavale', 3000,  14, 377,  true),
  ('captavale', 3000,  16, 345,  true),
  ('captavale', 4000,  8,  794,  true),
  ('captavale', 4000,  10, 663,  true),
  ('captavale', 4000,  12, 587,  true),
  ('captavale', 4000,  14, 516,  true),
  ('captavale', 4000,  16, 458,  true),
  ('captavale', 5000,  8,  992,  true),
  ('captavale', 5000,  10, 829,  true),
  ('captavale', 5000,  12, 729,  true),
  ('captavale', 5000,  14, 650,  true),
  ('captavale', 5000,  16, 577,  true),
  ('captavale', 6000,  8,  1184, true),
  ('captavale', 6000,  10, 984,  true),
  ('captavale', 6000,  12, 869,  true),
  ('captavale', 6000,  14, 774,  true),
  ('captavale', 6000,  16, 701,  true),
  ('captavale', 7000,  8,  1349, true),
  ('captavale', 7000,  10, 1145, true),
  ('captavale', 7000,  12, 1008, true),
  ('captavale', 7000,  14, 882,  true),
  ('captavale', 7000,  16, 793,  true),
  ('captavale', 8000,  8,  1547, true),
  ('captavale', 8000,  10, 1300, true),
  ('captavale', 8000,  12, 1142, true),
  ('captavale', 8000,  14, 1016, true),
  ('captavale', 8000,  16, 922,  true),
  ('captavale', 9000,  8,  1733, true),
  ('captavale', 9000,  10, 1476, true),
  ('captavale', 9000,  12, 1266, true),
  ('captavale', 9000,  14, 1130, true),
  ('captavale', 9000,  16, 1025, true),
  ('captavale', 10000, 8,  1931, true),
  ('captavale', 10000, 10, 1642, true),
  ('captavale', 10000, 12, 1442, true),
  ('captavale', 10000, 14, 1280, true),
  ('captavale', 10000, 16, 1164, true)
...
values
  ...
  ('dportenis', 13000, 20, 1294, true),
  ('dportenis', 14000, 8,  2538, true),
  ('dportenis', 14000, 10, 2170, true),
  ('dportenis', 14000, 12, 1925, true),
  ('dportenis', 14000, 14, 1750, true),
  ('dportenis', 14000, 16, 1619, true),
  ('dportenis', 14000, 18, 1517, true),
  ('dportenis', 14000, 20, 1393, true)
on conflict (source_code, amount, term_quincenas) do update
set base_payment = excluded.base_payment,
    is_available = excluded.is_available,
    updated_at = now();
